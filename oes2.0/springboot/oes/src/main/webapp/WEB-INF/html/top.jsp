    ...
    <aside id="sidebar_left" class="nano nano-light affix">
        <div class="sidebar-left-content nano-content">
            ...
            <ul class="nav sidebar-menu">
                <c:if test="${sessionScope.presonnel.roles==Contant.ROLES_ADMIN}">
                    <li class="sidebar-label pt15">基础信息管理</li>
                    <li>
                        <a class="accordion-toggle" href="#">
                            <span class="glyphicon glyphicon-check"></span>
                            <span class="sidebar-title">人员管理</span>
                            <span class="caret"></span>
                        </a>
                        <ul class="nav sub-nav">
                            <li>
                                <a href="/presonnel/list">
                                    <span class="glyphicon glyphicon-calendar"></span> 所有人员 </a>
                            </li>
                            <li class="active">
                                <a href="/presonnel/to_add">
                                    <span class="glyphicon glyphicon-check"></span> 添加人员 </a>
                            </li>
                        </ul>
                    </li>
                    <li class="active">
                        <a href="/dictionary/list?pId=1">
                            <span class="glyphicon glyphicon-home"></span>
                            <span class="sidebar-title">字典管理</span>
                        </a>
                    </li>
                    <li>
                </c:if>
