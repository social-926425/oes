    ...
    <div class="tray tray-center">
        ...
        <div class="admin-form theme-primary mw1000 center-block" style="padding-bottom: 175px;">
            <div class="panel heading-border">
                <%--@elvariable id="dictionary" type="fun.afterglow.oes.entity.Dictionary"--%>
                <form:form id="admin-form" name="addForm" action="/dictionary/update" modelAttribute="dictionary">
