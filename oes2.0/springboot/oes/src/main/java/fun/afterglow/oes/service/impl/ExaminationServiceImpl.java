...
public class ExaminationServiceImpl implements ExaminationService {
    ...
    public TestPaper HandleExam(TestResult testResult) {
        ...
        TestQuestion testQuestion0 = testQuestionDao.select(testPaper.getOption1());
        testQuestion0.setUpdateDate(new Date());
        testQuestion0.setStatus(Contant.FINISH);
        testQuestion0.setUseranwser(testResult.getUseranwser0());
        if (testQuestion0.getLibanwser().equals(testResult.getUseranwser0())){
            Integer Grade=testQuestion0.getQuestionBank().getScore();
            testQuestion0.setGrade(Grade);
            testQuestionDao.update(testQuestion0);
            Grades=Grade+Grades;
        }else {
            testQuestion0.setGrade(0);
            testQuestionDao.update(testQuestion0);
        }


        TestQuestion testQuestion1 = testQuestionDao.select(testPaper.getOption2());
        testQuestion1.setUpdateDate(new Date());
        testQuestion1.setStatus(Contant.FINISH);
        testQuestion1.setUseranwser(testResult.getUseranwser1());
        if (testQuestion1.getLibanwser().equals(testResult.getUseranwser1())){
        ...
        TestQuestion testQuestion2 = testQuestionDao.select(testPaper.getOption3());
        testQuestion2.setUpdateDate(new Date());
        testQuestion2.setStatus(Contant.FINISH);
        testQuestion2.setUseranwser(testResult.getUseranwser2());
        if (testQuestion2.getLibanwser().equals(testResult.getUseranwser2())){
        ...
        TestQuestion testQuestion3 = testQuestionDao.select(testPaper.getOption4());
        testQuestion3.setUpdateDate(new Date());
        testQuestion3.setStatus(Contant.FINISH);
        testQuestion3.setUseranwser(testResult.getUseranwser3());
        if (testQuestion3.getLibanwser().equals(testResult.getUseranwser3())){
        ...
        TestQuestion testQuestion4 = testQuestionDao.select(testPaper.getOption5());
        testQuestion4.setUpdateDate(new Date());
        testQuestion4.setStatus(Contant.FINISH);
        testQuestion4.setUseranwser(testResult.getUseranwser4());
        if (testQuestion4.getLibanwser().equals(testResult.getUseranwser4())){
        ...
        TestQuestion testQuestion5 = testQuestionDao.select(testPaper.getOption6());
        testQuestion5.setUpdateDate(new Date());
        testQuestion5.setStatus(Contant.FINISH);
        testQuestion5.setUseranwser(testResult.getUseranwser5());
        if (testQuestion5.getLibanwser().equals(testResult.getUseranwser5())){
        ...
        TestQuestion testQuestion6 = testQuestionDao.select(testPaper.getOption7());
        testQuestion6.setUpdateDate(new Date());
        testQuestion6.setStatus(Contant.FINISH);
        testQuestion6.setUseranwser(testResult.getUseranwser6());
        if (testQuestion6.getLibanwser().equals(testResult.getUseranwser6())){
        ...
        TestQuestion testQuestion7 = testQuestionDao.select(testPaper.getOption8());
        testQuestion7.setUpdateDate(new Date());
        testQuestion7.setStatus(Contant.FINISH);
        testQuestion7.setUseranwser(testResult.getUseranwser7());
        if (testQuestion7.getLibanwser().equals(testResult.getUseranwser7())){
        ...
        TestQuestion testQuestion8 = testQuestionDao.select(testPaper.getOption9());
        testQuestion8.setUpdateDate(new Date());
        testQuestion8.setStatus(Contant.FINISH);
        testQuestion8.setUseranwser(testResult.getUseranwser8());
        if (testQuestion8.getLibanwser().equals(testResult.getUseranwser8())){
        ...
        TestQuestion testQuestion9 = testQuestionDao.select(testPaper.getOption10());
        testQuestion9.setUpdateDate(new Date());
        testQuestion9.setStatus(Contant.FINISH);
        testQuestion9.setUseranwser(testResult.getUseranwser9());
        if (testQuestion9.getLibanwser().equals(testResult.getUseranwser9())){
        ...
        TestQuestion testQuestion10 = testQuestionDao.select(testPaper.getOption11());
        testQuestion10.setUpdateDate(new Date());
        testQuestion10.setStatus(Contant.FINISH);
        testQuestion10.setUseranwser(testResult.getUseranwser10());
        if (testQuestion10.getLibanwser().equals(testResult.getUseranwser10())){
        ...
        TestQuestion testQuestion11 = testQuestionDao.select(testPaper.getOption12());
        testQuestion11.setUpdateDate(new Date());
        testQuestion11.setStatus(Contant.FINISH);
        testQuestion11.setUseranwser(testResult.getUseranwser11());
        if (testQuestion11.getLibanwser().equals(testResult.getUseranwser11())){
        ...
        TestQuestion testQuestion12 = testQuestionDao.select(testPaper.getOption13());
        testQuestion12.setUpdateDate(new Date());
        testQuestion12.setStatus(Contant.FINISH);
        testQuestion12.setUseranwser(testResult.getUseranwser12());
        if (testQuestion12.getLibanwser().equals(testResult.getUseranwser12())){
        ...
        TestQuestion testQuestion13 = testQuestionDao.select(testPaper.getOption14());
        testQuestion13.setUpdateDate(new Date());
        testQuestion13.setStatus(Contant.FINISH);
        testQuestion13.setUseranwser(testResult.getUseranwser13());
        if (testQuestion13.getLibanwser().equals(testResult.getUseranwser13())){
        ...
        TestQuestion testQuestion14 = testQuestionDao.select(testPaper.getOption15());
        testQuestion14.setUpdateDate(new Date());
        testQuestion14.setStatus(Contant.FINISH);
        testQuestion14.setUseranwser(testResult.getUseranwser14());
        if (testQuestion14.getLibanwser().equals(testResult.getUseranwser14())){
        ...
        TestQuestion testQuestion15 = testQuestionDao.select(testPaper.getOptions1());
        testQuestion15.setUpdateDate(new Date());
        testQuestion15.setStatus(Contant.FINISH);
        String options15 = "";
        for (String list:testResult.getUseranwser15()){
            if (!list.equals("K")){
                options15=options15+list;
            }
        }
        testQuestion15.setUseranwser(options15);
        if (testQuestion15.getLibanwser().equals(options15)){
        ...
        TestQuestion testQuestion16 = testQuestionDao.select(testPaper.getOptions2());
        ...
        TestQuestion testQuestion17 = testQuestionDao.select(testPaper.getOptions3());
        testQuestion17.setUpdateDate(new Date());
        testQuestion17.setStatus(Contant.FINISH);
        String options17 = "";
        for (String list:testResult.getUseranwser17()){
            if (!list.equals("K")){
        ...
        TestQuestion testQuestion18 = testQuestionDao.select(testPaper.getOptions4());
        testQuestion18.setUpdateDate(new Date());
        testQuestion18.setStatus(Contant.FINISH);
        String options18 = "";
        for (String list:testResult.getUseranwser18()){
            if (!list.equals("K")){
        ...
        TestQuestion testQuestion19 = testQuestionDao.select(testPaper.getOptions5());
        testQuestion19.setUpdateDate(new Date());
        testQuestion19.setStatus(Contant.FINISH);
        String options19 = "";
        for (String list:testResult.getUseranwser19()){
            if (!list.equals("K")){
        ...
        TestQuestion testQuestion20 = testQuestionDao.select(testPaper.getSubjective1());
        testQuestion20.setUseranwser(testResult.getUseranwser20());
        testQuestion20.setStatus(Contant.FINISH);
        testQuestionDao.update(testQuestion20);


        TestQuestion testQuestion21 = testQuestionDao.select(testPaper.getSubjective2());
        testQuestion21.setUseranwser(testResult.getUseranwser21());
        testQuestion21.setStatus(Contant.FINISH);
        testQuestionDao.update(testQuestion21);


        TestQuestion testQuestion22 = testQuestionDao.select(testPaper.getSubjective3());
        testQuestion22.setUseranwser(testResult.getUseranwser22());
