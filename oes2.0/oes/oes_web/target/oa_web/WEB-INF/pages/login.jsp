                        ...
                        <div class="panel-body bg-light p25 pb15">
                            <div class="section">
                                ...
                                <label for="number" class="field prepend-icon">
                                    <input type="text" name="number" id="number" class="gui-input" placeholder="请输入学号或工号..." value="1101">
                            ...
                            <div class="section">
                                ...
                                <label for="password" class="field prepend-icon">
                                    <input type="password" name="password" id="password" class="gui-input" placeholder="请输入密码..." value="1101">
